            ...
            <div class="container">
                <div class="section">
                    ...
                    <div id="table-datatables section">
                        <h4 class="header">Bảng thể loại khóa học</h4>
                        <div class="row">
                            <div class="col s12">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <c:if test="${currentFunction.canUpdate}">
                                                    <a href="${pageContext.request.contextPath}/admin/course/type/edit?id=${type.id}"
                                                       class="btn waves-effect waves-light gradient-45deg-green-teal">
                                                        Sửa
                                                    </a>
                                                </c:if> |
                                                <c:if test="${currentFunction.canDelete}">
                                                    <a href="${pageContext.request.contextPath}/admin/course/type/delete?id=${type.id}"
