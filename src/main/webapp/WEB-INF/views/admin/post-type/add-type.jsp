                    ...
                    <div class="row">
                        <div class="col s10 m6 l6">
                            ...
                            <ol class="breadcrumbs">
                                ...
                                <c:forEach var="tempFunction" items="${functionList}">
                                    <c:if test="${tempFunction.id == 'PostTypeList'}">
                                ...
                                <li><a href="${currentFunction.url}/add">Tạo thể loại</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row section">
                        <div class="col s12 m12 l12">
                            <div class="card-panel">
                                <div class="row">
                                    <form:form
                                            action="${pageContext.request.contextPath}/admin/event/post/type/add"
                                            method="post" class="col s12" modelAttribute="type">
