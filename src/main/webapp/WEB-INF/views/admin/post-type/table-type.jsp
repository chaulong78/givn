                ...
                <div class="section">
                    ...
                    <div class="row">
                        <c:if test="${currentFunction.canCreate}">
                            <a href="/admin/event/post/type/add"
                    ...
                    <div id="table-datatables section">
                        <h4 class="header">Bảng thể loại bài viết</h4>
                        <div class="row">
                            <div class="col s12">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <c:if test="${currentFunction.canUpdate}">
                                                    <a href="${pageContext.request.contextPath}/admin/event/post/type/edit?id=${type.id}"
                                                       class="btn waves-effect waves-light gradient-45deg-green-teal">
                                                        Sửa
                                                    </a>
                                                </c:if> |
                                                <c:if test="${currentFunction.canDelete}">
                                                    <a href="${pageContext.request.contextPath}/admin/event/post/type/delete?id=${type.id}"
