            ...
            <div class="container">
                <div class="section">
                    ...
                    <div id="table-datatables section">
                        <h4 class="header">Bảng bài viết</h4>
                        <div class="row">
                            <div class="col s12">
                                <table id="data-table-simple" class="responsive-table display"
                                    ...
                                    <c:forEach var="post" items="${postList}">
                                        <tr>
                                            ...
                                            <td><b>
                                                <span style="color: ${post.enabled? '#245bff': '#ff4f39'}">${post.enabled? 'Kích hoạt': 'Ẩn'}</span>
                                            </b></td>
                                            <td>
                                                <c:if test="${currentFunction.canUpdate}">
                                                    <a href="${pageContext.request.contextPath}/admin/event/post/edit?id=${post.id}"
                                                       class="btn waves-effect waves-light gradient-45deg-green-teal">
                                                        Sửa
                                                    </a>
                                                </c:if> |
                                                <c:if test="${currentFunction.canDelete}">
                                                    <a href="${pageContext.request.contextPath}/admin/event/post/delete?id=${post.id}"
