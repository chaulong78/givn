                    ...
                    <div class="row">
                        <div class="col s10 m6 l6">
                            ...
                            <ol class="breadcrumbs">
                                ...
                                <c:forEach var="tempFunction" items="${functionList}">
                                    <c:if test="${tempFunction.id == 'SpeakerList'}">
                                ...
                                <li><a href="${currentFunction.url}/add">Tạo diễn giả</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row section">
                        <div class="col s12 m12 l12">
                            <div class="card-panel">
                                <div class="row">
                                    <form:form
                                            action="${pageContext.request.contextPath}/admin/event/speaker/edit"
                                            method="post" class="col s12" modelAttribute="speaker">
                                        <div class="row">
                                            ...
                                            <div class="input-field col s12">
                                                ...
                                                <label for="name">Tên diễn giả</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input id="image" name="image" type="text"
                                                       value="${speaker.image}" required>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input id="description" name="description" type="text"
                                                       value="${speaker.description}" required>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <button class="btn cyan waves-effect waves-light right"
                                                        ...
                                                        onclick="return confirm('Sửa thông tin diễn giả?')">
                                                    Submit
