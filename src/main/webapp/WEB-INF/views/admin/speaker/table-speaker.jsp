                ...
                <div class="section">
                    ...
                    <div class="row">
                        <c:if test="${currentFunction.canCreate}">
                            <a href="/admin/event/speaker/add"
                    ...
                    <div id="table-datatables section">
                        <h4 class="header">Bảng diễn giả</h4>
                        <div class="row">
                            <div class="col s12">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <c:if test="${currentFunction.canUpdate}">
                                                    <a href="${pageContext.request.contextPath}/admin/event/speaker/edit?id=${speaker.id}"
                                                       class="btn waves-effect waves-light gradient-45deg-green-teal">
                                                        Sửa
                                                    </a>
                                                </c:if> |
                                                <c:if test="${currentFunction.canDelete}">
                                                    <a href="${pageContext.request.contextPath}/admin/event/speaker/delete?id=${speaker.id}"
                                                       class="btn waves-effect waves-light gradient-45deg-purple-deep-orange"
                                                       onclick="return confirm('Xóa diễn giả?')">
                                                        Xóa
                                                    </a>
                                                </c:if>
                                            </td>
