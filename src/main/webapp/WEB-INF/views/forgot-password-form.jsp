...
<div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
        <form:form class="login-form" action="/forgot-password/process" method="post">
            <div class="row">
                <div class="input-field col s12 center">
                    ...
                    <h4>Quên mật khẩu</h4>
                    <p class="center">Nhập email của bạn</p>
            ...
            <div class="row">
                <div class="input-field col s12">
                    <button type="submit" class="btn waves-effect waves-light col s12">Gửi</button>
                </div>
                <div class="input-field col s12">
                    <p class="margin sign-up">
                        <a href="/login">Đăng nhập</a>
                        <a href="/register" class="right">Đăng ký</a>
                    </p>
                </div>
            </div>
        </form:form>
