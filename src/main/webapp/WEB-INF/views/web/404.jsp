...
<head>
    ...
    <title>Get Ins - Không tìm thấy trang</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3 text-center">
                <img src="${pageContext.request.contextPath}/webstatic/src/images/404.png" alt="404 page">
                <div class="not_found">
                    <h3>Oops! Trang không tồn tại</h3>
                    <a href="${pageContext.request.contextPath}/" class="btn btn--round btn--default">Trở về trang chủ</a>
                </div>
            </div>
        </div>
    </div>
