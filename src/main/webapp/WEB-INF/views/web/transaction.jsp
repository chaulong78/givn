...
<head>
    ...
    <title>Get Ins - Điều khoản giao dịch</title>
        ...
        <div class="row">
            <div class="col-md col-sm-12">
                <div class="content_area">
                    <h1 class="content_area--title">Điều khoản giao dịch của
                        <span class="highlight">Get Ins</span>
                    </h1>
                    <br>
                    <p>
                        <strong>1. </strong>
                        <strong>Chấp nhận đơn hàng và giá cả</strong>
                    </p>
                    <p>
                        a) Chúng tôi có quyền từ chối hoặc hủy đơn hàng của quý khách vì bất kỳ lý
                        do gì vào bất kỳ lúc nào. chúng tôi có thể hỏi thêm về số điện thoại và địa
                        chỉ trước khi nhận đơn hàng.
                    </p>
                    <p>
                        b) Chúng tôi cam kết sẽ cung cấp thông tin giá cả chính xác nhất cho người
                        tiêu dùng. Tuy nhiên, đôi lúc vẫn có sai sót xảy ra, ví dụ như trường hợp
                        giá sản phẩm không hiển thị chính xác trên trang web hoặc sai giá, tùy theo
                        từng trường hợp chúng tôi sẽ liên hệ hướng dẫn hoặc thông báo hủy đơn hàng
                        đó cho quý khách. chúng tôi cũng có quyền từ chối hoặc hủy bỏ bất kỳ đơn
                        hàng nào dù đơn hàng đó đã hay chưa được xác nhận hoặc đã bị thanh toán.
                    </p>
                    <p>
                        <strong>2. </strong>
                        <strong>Thay đổi, hủy bỏ giao dịch tại website</strong>
                    </p>
                    <p>
                        a) Trong mọi trường hợp, khách hàng đều có quyền chấm dứt giao dịch nếu đã
                        thực hiện các biện pháp sau đây:
                    </p>
                    <p>
                        b) Thông báo cho chúng tôi về việc hủy giao dịch qua đường dây nóng 0973
                        755 035
                    </p>
                    <p>
                        c) Trả lại linh kiện đã nhận nhưng chưa sử dụng hoặc hưởng bất kỳ lợi ích
